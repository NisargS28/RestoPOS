...
File: .env.local
```
NEXT_PUBLIC_SUPABASE_URL=https://lvvblvhygbppftuiklne.supabase.co
NEXT_PUBLIC_SUPABASE_PUBLISHABLE_DEFAULT_KEY=sb_publishable_1cJuosbIdvs6Ty-StJtUOA_SWMvURKg
```
